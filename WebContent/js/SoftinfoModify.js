...
function loadSoftInfo(softid)
{
	if(softid){
		$("#SoftID").val(softid);
		$.ajax({
	    	url: '/Electricity/GetDetailInfo?infotype=soft&id='+softid+"&tid="+Math.random(),
...
function modifyBasicinfo()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/Electricity/UpdateSoftinfo?scope=basicinfo&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
...
function modifySoftFuncDesc()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/Electricity/UpdateSoftinfo?scope=softfunctiondesc&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
...
function modifySoftComputeExample()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/Electricity/UpdateSoftinfo?scope=softcomputeexample&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
...
function modifySoftResultExample()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/Electricity/UpdateSoftinfo?scope=softresultexample&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
...
function modifyContactinfo()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/Electricity/UpdateSoftinfo?scope=contactinfo&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
