...
function applyNode(username,toolname,objmodelID)
{
	...
	{ 
		...
		var applyurl="/Electricity/ApplynodeServlet";
		if(objmodelID){
		...
		function opennode(ip,user,psw,port,tool,loginuser,model){
			...
			var newnodeurl="/Electricity/Webfront/Tool.html";
			$.ajax({   
			     type: "POST",   
			     url: newnodeurl,   
...
//			        	
//			        	var relseaeServletUrl="/Electricity/ReleasenodeServlet?nodeip="+ip+"&account="+user+
