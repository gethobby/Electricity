                ...
                [
                    ...
                    timeTicket = setInterval(function (){
                    	if(document.getElementById('nodestatus').style.display!="none"){
                	    	var nstatusurl="/Electricity/NodeStatus?nodeid="+nodename.substring(11)+"&tid="+Math.random();
    	...
    	require([
            ...
            timeTicket = setInterval(function (){
            	if(document.getElementById('serverstatus').style.display!="none"){
        	    	var sstatusurl="/Electricity/ServerStatus?tid="+Math.random();
