...
public interface Gobal {
	...
	/*以下若干行配置为服务器配置*/
	//存放与存储节点机交流的C++软件的路径
	String NODE_COMMUNICATE_APP="D:\\Electricity\\Electricity_Deploy\\SavedServerSide.exe";
	String RESULT_RECEIVE_APP="D:\\Electricity\\Electricity_Deploy\\SavedResultServer.exe";
	//存放与软件节点机交流的C++软件路径
	...
	//所有模型文件存放路径
	String OBJECT_ROOT_DIR="D:\\Electricity\\ObjectModelfile\\";
	//所有图片存放路径
	...
	//存储节点机统一存储模型文件的位置 
	String NODE_OBJECT_DIR = "D:\\Electricity\\";
	int NODE_SOCKET_PORT = 6000;
	
	//软件节点机工作空间 
	String SOFT_WORK_DIR = "D:\\Electricity\\";
