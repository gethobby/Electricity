...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ch.isSuccess())
		{
			...
			if(request.getParameter("backsystem")==null){
				if(frompage==null||frompage=="")
					response.sendRedirect("/Electricity/Webfront/ComputeMain.jsp");
				else response.sendRedirect("/Electricity/Webfront/"+frompage);
				logger.debug(username+" Login in success!");
			}
			else{
				if(frompage==null||frompage=="")
					response.sendRedirect("/Electricity/Webback/UserManage.jsp");
				else response.sendRedirect("/Electricity/Webback/"+frompage);
		...
		else
		{
			...
			//response.sendRedirect("/Electricity/login.jsp?loginerror=true");
		}
